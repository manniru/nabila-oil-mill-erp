...
- **Project**: `nabila-oil-mill-erp/src`
- **Domain**: Fintech & Digital Banking
- **Scope**: Dedicated project repository for src supporting enterprise software system workflows and operations.
...
- **Frontend / Mobile Agent**: Implements user interfaces, state management, and client-side interactions in `TypeScript`.
